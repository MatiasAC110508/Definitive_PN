...
export class ResendEmailService implements EmailService {
  ...
  private getFromAddress() {
    // If you don't have a custom domain on Resend, you must use their testing domain or the domain you verified.
    // Recommended to change to your verified domain (e.g., 'notificaciones@perfectnails.art')
    return process.env.RESEND_FROM_EMAIL || "Perfect Nails <onboarding@resend.dev>";
  }

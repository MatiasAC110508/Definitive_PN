  ...
  return (
    <div className="pt-[4.5rem]">
      <section className="relative overflow-hidden bg-[#f8f9fa] px-4 py-20 sm:px-6 lg:px-8 border-b-0">
        <Image
          src="/images/backgrounds/products.png"
            ...
            <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between pt-4">
                ...
                <div className="flex items-center gap-3 overflow-x-auto no-scrollbar py-2 px-1">
                  ...
                  {categories.map((category) => (
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        setActiveCategory(category.slug as ProductCategorySlug)
                      }
                      className={cn(
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-end gap-3 mr-2 lg:justify-end">
                  <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[var(--gold)] opacity-70">
                    Ordenar por
                  </span>
        ...
        {filteredProducts.length > 0 ? (
          <div className="flex flex-wrap items-start justify-center gap-8 lg:gap-10">
            {filteredProducts.map((product, index) => (
              <div
                key={product.id}
                className="w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.7rem)] xl:w-[calc(25%-1.9rem)] max-w-[320px]"
              >
            ...
            <Card className="border-dashed border-2 border-[var(--line)] bg-white/30 backdrop-blur-sm">
              <CardContent className="p-20 text-center">
                ...
                <p className="mt-4 text-lg text-[var(--ink-soft)] max-w-md mx-auto">
                  No encontramos productos para &quot;{query}&quot;. Prueba con
                  otra palabra clave o cambia de categoría.
                </p>
                <Button
                  variant="luxury"
                  className="mt-8"
          ...
          <div className="grid lg:grid-cols-2 items-center gap-16">
            <div>
              ...
              <p className="text-xl text-white/70 leading-relaxed mb-10">
                Todas nuestras prendas y cosméticos pasan por un control de
                calidad riguroso para asegurar que recibas solo lo mejor de la
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-sm text-white/50">
                    Entrega cuidada y personalizada en empaques de lujo.
                  </p>
                </div>
                <div>
                  <h4 className="text-[var(--gold)] font-bold uppercase tracking-widest text-xs mb-2">
                  ...
                  <p className="text-sm text-white/50">
                    Proceso sencillo y elegante si no estás satisfecha.
                  </p>
                </div>
              </div>
            </div>
            <div className="relative aspect-square lg:aspect-auto lg:h-[400px] rounded-2xl overflow-hidden border border-white/10">
              ...
              <div className="absolute bottom-8 left-8 z-20">
                <p className="font-display text-3xl font-semibold italic text-[var(--gold-soft)]">
                  &ldquo;La elegancia es la única belleza que nunca se
                  marchita&rdquo;
                </p>
